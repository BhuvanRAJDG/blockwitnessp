      ...
      <div className="relative">
        ...
        <input
          className={`
            ...
            focus:border-primary-500 focus:ring-4 focus:ring-primary-500/20 focus:shadow-glow
            focus:outline-none focus:scale-[1.01]
            hover:border-primary-300 hover:shadow-sm
            disabled:bg-dark-50 disabled:cursor-not-allowed
            ${error ? 'border-danger-500 focus:border-danger-500 focus:ring-danger-500/20 focus:shadow-glow-accent' : ''}
